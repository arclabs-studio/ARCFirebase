...
let package = Package(name: "ARCFirebase",
                      platforms: [.iOS(.v17),
                                  .macOS(.v14),
                                  .watchOS(.v10),
                                  .visionOS(.v1)],
                      products: [// Core - Required by all other modules
                          .library(name: "ARCFirebaseCore",
                      ...
                      targets: [// MARK: - Core
                          ...
                          .target(name: "ARCFirebaseCore",
                                  dependencies: [.product(name: "FirebaseCore", package: "firebase-ios-sdk"),
                          ...
                          .target(name: "ARCFirebaseAnalytics",
                                  dependencies: ["ARCFirebaseCore",
                          ...
                          .target(name: "ARCFirebaseCrashlytics",
                                  dependencies: ["ARCFirebaseCore",
                          ...
                          .target(name: "ARCFirebasePersistence",
                                  dependencies: ["ARCFirebaseCore",
                          ...
                          .target(name: "ARCFirebaseStorage",
                                  dependencies: ["ARCFirebaseCore",
                          ...
                          .target(name: "ARCFirebaseFeatureFlags",
                                  dependencies: ["ARCFirebaseCore",
                          ...
                          .testTarget(name: "ARCFirebaseCoreTests",
                                      dependencies: ["ARCFirebaseCore"],
                                      swiftSettings: [.swiftLanguageMode(.v6)]),
                          .testTarget(name: "ARCFirebaseAuthTests",
                                      dependencies: ["ARCFirebaseAuth"],
                                      swiftSettings: [.swiftLanguageMode(.v6)]),
                          .testTarget(name: "ARCFirebaseAnalyticsTests",
                                      dependencies: ["ARCFirebaseAnalytics"],
                                      swiftSettings: [.swiftLanguageMode(.v6)]),
                          .testTarget(name: "ARCFirebaseCrashlyticsTests",
                                      dependencies: ["ARCFirebaseCrashlytics"],
                                      swiftSettings: [.swiftLanguageMode(.v6)]),
                          .testTarget(name: "ARCFirebasePersistenceTests",
                                      dependencies: ["ARCFirebasePersistence"],
                                      swiftSettings: [.swiftLanguageMode(.v6)]),
                          .testTarget(name: "ARCFirebaseStorageTests",
                                      dependencies: ["ARCFirebaseStorage"],
                                      swiftSettings: [.swiftLanguageMode(.v6)]),
                          .testTarget(name: "ARCFirebaseAITests",
