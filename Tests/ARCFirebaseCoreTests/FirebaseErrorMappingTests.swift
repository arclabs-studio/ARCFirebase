...
struct FirebaseErrorMappingTests {
    ...
    @Test("Firestore NOT_FOUND (5) maps to documentNotFound")
    func firestoreNotFound() {
    ...
    @Test("Firestore PERMISSION_DENIED (7) maps to permissionDenied")
    func firestorePermissionDenied() {
    ...
    @Test("Firestore unknown code maps to unknown")
    func firestoreUnknownCode() {
    ...
    @Test("Auth ERROR_INVALID_CREDENTIAL (17004) maps to invalidCredential")
    func authInvalidCredential() {
    ...
    @Test("Auth ERROR_EMAIL_ALREADY_IN_USE (17007) maps to emailAlreadyInUse")
    func authEmailAlreadyInUse() {
    ...
    @Test("Auth ERROR_INVALID_EMAIL (17008) maps to invalidEmail")
    func authInvalidEmail() {
    ...
    @Test("Auth ERROR_NO_SUCH_PROVIDER (17012) maps to noSuchProvider")
    func authNoSuchProvider() {
    ...
    @Test("Auth ERROR_REQUIRES_RECENT_LOGIN (17014) maps to requiresRecentLogin")
    func authRequiresRecentLogin() {
    ...
    @Test("Auth ERROR_PROVIDER_ALREADY_LINKED (17015) maps to providerAlreadyLinked")
    func authProviderAlreadyLinked() {
    ...
    @Test("Auth ERROR_WEAK_PASSWORD (17016) maps to weakPassword")
    func authWeakPassword() {
    ...
    @Test("NSURLErrorDomain maps to networkError")
    ...
    @Test("Unknown domain maps to unknown")
    func unknownDomain() {
